...
interface TriviaTitansRepository {
    ...
    // region text choice
    suspend fun getTextChoiceQuestions(limit: Int, categories: String, difficulties: String): List<TextChoiceEntity>
    //endregion

    // region image choice
    suspend fun getImageChoiceQuestions(limit: Int, categories: String, difficulties: String): List<ImageChoiceEntity>
